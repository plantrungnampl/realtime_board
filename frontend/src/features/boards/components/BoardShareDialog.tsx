                  ...
                  {invitees.map((email) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="ml-1 rounded-sm text-text-muted hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500/50"
                        aria-label={t("board.inviteRemoveEmail", { email })}
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </span>
