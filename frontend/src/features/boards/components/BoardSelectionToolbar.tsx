            ...
            {FILL_COLORS.map((color) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={cn(
                    "h-5 w-5 rounded-full border border-border/70 transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500/50",
