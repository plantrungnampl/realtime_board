...
pub async fn find_organization_by_id(
    ...
    let organization = crate::log_query_fetch_optional!(
        "organizations.find_by_id",
        sqlx::query_as(
            r#"
                SELECT *
...
pub async fn get_member_by_id(
    ...
    let member = crate::log_query_fetch_optional!(
...
pub async fn list_email_invites(
    ...
    let rows = crate::log_query_fetch_all!(
        "organizations.list_email_invites",
        sqlx::query_as::<_, OrganizationInviteRecord>(
            r#"
                SELECT
                    id,
                    organization_id,
...
pub async fn get_email_invite_by_id(
    ...
    let invite = crate::log_query_fetch_optional!(
        "organizations.get_email_invite_by_id",
        sqlx::query_as::<_, OrganizationInviteRecord>(
            r#"
                SELECT
                    id,
...
pub async fn get_email_invite_by_token(
    ...
    let invite = crate::log_query_fetch_optional!(
        "organizations.get_email_invite_by_token",
        sqlx::query_as::<_, OrganizationInviteRecord>(
            r#"
                SELECT
                    id,
...
pub async fn list_pending_invitations(
    ...
    let rows = crate::log_query_fetch_all!(
        ...
        sqlx::query_as::<_, OrganizationInvitationRow>(
            r#"
                SELECT
                    om.id AS member_id,
                    om.role,
...
pub async fn create_email_invite(
    ...
    crate::log_query_execute!(
        "organizations.create_email_invite",
        sqlx::query(
            r#"
...
pub async fn resend_email_invite(
    ...
    crate::log_query_execute!(
        "organizations.resend_email_invite",
        sqlx::query(
            r#"
...
pub async fn delete_email_invite(
    ...
    crate::log_query_execute!(
        "organizations.delete_email_invite",
        sqlx::query(
            r#"
...
pub async fn add_member_from_email_invite(
    ...
    crate::log_query_execute!(
        "organizations.add_member_from_invite",
        sqlx::query(
            r#"
...
pub async fn demote_other_owners(
    ...
    crate::log_query_execute!(
        "organizations.demote_other_owners",
        sqlx::query(
            r#"
                UPDATE core.organization_member
                SET role = $3, updated_at = NOW()
...
pub async fn find_owner_user_id(
    ...
    let owner_id = crate::log_query_fetch_optional!(
        "organizations.find_owner_user_id",
...
pub async fn count_organization_email_invites(
    ...
    let count = crate::log_query_fetch_one!(
        "organizations.count_email_invites",
        sqlx::query_scalar::<_, i64>(
            r#"
                SELECT COUNT(*)
                FROM core.organization_invite
...
pub async fn list_organizations_by_user(
    ...
    let rows = crate::log_query_fetch_all!(
        "organizations.list_by_user",
        sqlx::query_as::<_, OrganizationSummaryRow>(
            r#"
...
pub async fn add_owner_member(
    ...
    crate::log_query_execute!(
        "organizations.add_owner_member",
        sqlx::query(
            r#"
                INSERT INTO core.organization_member (
                    organization_id,
