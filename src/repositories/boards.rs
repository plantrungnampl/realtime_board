...
pub async fn find_board_by_id_including_deleted(
    ...
    let board = crate::log_query_fetch_optional!(
        "boards.find_by_id_including_deleted",
        sqlx::query_as::<_, Board>(
            r#"
                SELECT *
                FROM board.board
...
pub async fn get_board_member_access(
    ...
    let member = crate::log_query_fetch_optional!(
        "boards.get_member_access",
        sqlx::query_as::<_, BoardMemberRecord>(
            r#"
...
pub async fn load_board_organization_id(
    ...
    let organization_id = crate::log_query_fetch_optional!(
        "boards.load_organization_id",
...
pub async fn list_boards_requiring_owner_transfer(
    ...
    let rows = crate::log_query_fetch_all!(
        "boards.list_requiring_owner_transfer",
...
pub async fn remove_board_memberships_by_organization(
    ...
    crate::log_query_execute!(
        "boards.remove_memberships_by_org",
        sqlx::query(
            r#"
...
pub async fn count_personal_boards_by_owner(
    ...
    let count = crate::log_query_fetch_one!(
        "boards.count_personal_by_owner",
        sqlx::query_scalar::<_, i64>(
            r#"
                SELECT COUNT(*)
                FROM board.board b
