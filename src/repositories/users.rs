...
pub async fn verification_sent_at(
    ...
    let value = crate::log_query_fetch_one!(
...
pub async fn set_verification_sent_at(
    ...
    crate::log_query_execute!(
        "users.set_verification_sent_at",
        sqlx::query(
            r#"
                UPDATE core.user
                SET
